...
type alias Model = { topics: List Topic, filters: Athena.Filter.Model.Model  }



initialModel : Model
initialModel = { topics = [], filters = Athena.Filter.Model.initialModel }
...
update action model =
  case action of
    ...
    HandleFilter act ->
      let (newFilter, effects) = Athena.Filter.Update.update act model.filters
      in noEffects { model | filters = newFilter }
